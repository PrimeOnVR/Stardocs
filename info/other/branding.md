---
description: >-
  Starlight's branding over time, with press packs, descriptions, usage
  guidelines, and more.
icon: pen-field
---
...
{% tab title="Starlight" %}
## ![](../../.gitbook/assets/StarlightLogo.png)  Starlight
...
{% tab title="Starlight Studios" %}
## ![](<../../.gitbook/assets/StarlightLogo (1).png>)  Starlight Studios
